"""
Rule deal 010 v1: PDF source text extraction gate.

Requires PDF-direct deal extractions to record a text-extraction sidecar so
...
class Rule(ValidationRule):
    """Checks that PDF-direct deal extractions identify extracted text provenance."""
    ...
    def description(self) -> str:
        ...
        return "PDF-direct deal extractions must record extracted text provenance"
