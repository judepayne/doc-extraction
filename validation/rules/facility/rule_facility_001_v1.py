"""
Rule facility 001 v1: JSON Schema validation.

Validates that a facility extraction conforms to its declared JSON schema.
"""
...
class Rule(ValidationRule):
    """Validates facility entity data against its declared JSON schema."""
    ...
    def description(self) -> str:
        ...
        return "Facility extraction must conform to its declared JSON schema"
    ...
    def run(self) -> Tuple[str, str]:
        ...
        if not schema_url:
            return ("FAIL", "Facility extraction missing required $schema field")
